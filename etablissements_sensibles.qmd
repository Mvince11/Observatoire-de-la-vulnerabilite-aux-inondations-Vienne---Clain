      ...
      map.on('click', 'indicateurs14Layer', (e) => {
        ...
        <style>
          ...
          <center>${nom}</center>
            ...
            <p style="margin:auto;"><strong>Nombre d'établissements sensibles en zone inondable :</strong> ${dommages}</p>
          </div>
        `;
        ...
        new maplibregl.Popup({closeButton: false})
         ...
         <strong style="font-size:1.1em"><i class="bi bi-building"></i> Nombre d'établissements sensibles en zone inondable :</strong> ${dommages}<br>
         `;
      });

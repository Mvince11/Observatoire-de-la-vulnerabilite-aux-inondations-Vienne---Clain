    ...
    // Ajout des couches vectorielles
      ...
      map.on('click', 'indicateurs12aLayer', (e) => {
        ...
        new maplibregl.Popup({closeButton: false})
         ...
         <strong><i class="bi bi-geo-alt-fill"></i> Commune :</strong> ${nom}<br>
         <strong><i class="bi bi-people-fill"></i> Nombre d'habitants :</strong> ${population}<br>
         <strong><i class="bi bi-droplet-half"></i> Nombre de personnes en zone fortement inondable :</strong> ${s12a}
         `;
      });
...
//| expandable: false
md`
<div id="donnees" style="font-family: Arial, sans-serif; font-size: 16px; line-height: 1.5;">

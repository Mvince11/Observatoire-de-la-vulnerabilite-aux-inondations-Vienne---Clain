    ...
    // Ajout des couches vectorielles
      ...
      map.on('click', 'indicateurs114bLayer', (e) => {
        ...
        new maplibregl.Popup({closeButton: false})
         ...
         <strong style="font-size:1.1em"><i class="fas fa-map"></i> Nombre de personnes sans Plan Communal de Sauvegardes (PCS) obligatoire ou qui doit être révisé :</strong> ${dommages}<br>
         `;
      });

    ...
    // Ajout des couches vectorielles
      ...
      map.on('click', 'indicateurs31atxLayer', (e) => {
        ...
        new maplibregl.Popup({closeButton: false})
         ...
         <strong style="font-size:1.2em"><i class="bi bi-person-fill"></i> Nombre d'habitants en zone inondable                 :</strong> ${hab_inondable}
         `;
      });



      map.on('mouseenter', 'indicateurs31atxLayer', () => {
...
// Données filtrées et triées
    sorted = data
      .map(d => ({
        ...d,
        s31atx: isNaN(+d.s31atx) ? 0 : +d.s31atx  // attrape null, undefined, "", "NaN", etc.
      }))
      .filter(d => d.s31atx <= slider)
...
Plot.plot({
  ...
  y: {
    grid: true,
    label: "Taux (%)",
    domain: [0, Math.max(...sorted.map(d => d.s31atx))],

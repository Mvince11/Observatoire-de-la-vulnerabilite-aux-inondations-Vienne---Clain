  ...
  maxzoom: 19
    ...
    // Ajout des couches vectorielles
      ...
      map.on('click', 'indicateurs13bLayer', (e) => {
        ...
        const dommages = !isNaN(s13bValue)
          ? s13bValue.toLocaleString('fr-FR')
          : 'Non disponible';
        ...
        new maplibregl.Popup({closeButton: false})
         ...
         <strong style="font-size:1.1em"><i class="fas fa-campground"></i> Nombre de personnes en campings potentiellement impactées :</strong> ${dommages}<br>
         `;
      });

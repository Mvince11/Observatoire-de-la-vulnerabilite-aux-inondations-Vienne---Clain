    ...
    // Ajout des couches vectorielles
      ...
      map.on('click', 'indicateurs114cLayer', (e) => {
        ...
        new maplibregl.Popup({closeButton: false})
         ...
         <strong style="font-size:1.1em"><i class="fas fa-map"></i> Nombre de personnes sans Document d’Information Communal sur les Risques Majeurs (DICRIM) obligatoire ou qui doit être révisé :</strong> ${dommages}<br>
         `;
      });
